...
vim.g.dark_scheme = 'catppuccin-nvim'
...
-- Manually set the terminal title using the same format as zsh.
-- This prevents the title from becoming `fg` after suspending and resuming nvim.
o.title       = true
